// Planet and body data for the Taunor system.
...
const PLANET_DATA: Record<string, BodyData> = {
  ...
  aethon: {
    ...
    climate:
      "Temperate to subtropical across most landmasses. Polar regions are cold but inhabited. Equatorial zones experience extreme prolonged daylight during the Pale Season.",
    renderColor: "#4A90D9",
    accentColor: "rgba(74, 144, 217, 0.35)",
    spaceports: [
      {
        id: "aethon_orbital_ring",
        name: "Aethon Orbital Ring",
        type: "orbital",
        description:
          "The primary deep-system terminal. A permanent structure in low orbit and the busiest spaceport in the system. Most long-haul voyages depart and arrive here.",
      },
      {
        id: "caelum_platform",
        name: "Caelum Platform",
        type: "atmospheric",
        description:
          "A mid-atmosphere floating station above the equatorial zone, for atmospheric entry and exit without full surface descent. Popular with passengers connecting to orbital departures.",
      },
      {
        id: "port_ashara",
        name: "Port Ashara",
        type: "surface",
        description:
          "The oldest surface spaceport on Aethon. Historically significant, northern continent. Handles heritage and diplomatic traffic alongside commercial operations.",
      },
      {
        id: "meridian_base",
        name: "Meridian Base",
        type: "surface",
        description:
          "Southern hemisphere, more utilitarian and cargo-focused. The highest freight throughput of any surface port in the system.",
      },
      {
        id: "eastgate_terminal",
        name: "Eastgate Terminal",
        type: "surface",
        description:
          "High-capacity commercial hub, eastern seaboard. The newest and most modern surface port, opened to relieve pressure on Port Ashara.",
      },
      {
        id: "seren_relay",
        name: "Seren Relay Station",
        type: "orbital",
        description:
          "A small departure staging installation in Seren's orbital path. Used as a jump-off point for outer-system routes, particularly those heading through the Scatter.",
      },
    ],
    routes: [
      {
        routeId: "aethon_kalos",
        to: "kalos",
        toName: "Kalos",
        shipClass: "Tethys",
      ...
      {
        routeId: "aethon_vareth_scenic",
        to: "kalos",
        toName: "Kalos via Vareth",
        shipClass: "Lunara",
        frequency: "Every 21 days",
        scenic: true,
      },
      {
        routeId: "aethon_calyx_scenic",
        to: "calyx",
        toName: "Calyx (Scenic)",
        shipClass: "Lunara",
    ...
    imageSlots: {
      ...
      surface:
        "Aethon megacity sprawl — horizontal arcology architecture extending to the horizon",
      spaceport:
        "Aethon Orbital Ring interior — departure terminal with viewports overlooking the planet surface",
      extra:
        "Aethon equatorial zone during Pale Season — dual-sun lighting casting twin shadows",
    },
  },
  ...
  kalos: {
    ...
    description:
      "The largest and most developed moon in the Vareth system. Deep mining operations, the largest refinery complex in the mid-system, and a frontier energy that attracts workers, traders, and a certain kind of traveller who wants somewhere that still feels raw.",
    ...
    climate:
      "Extreme — thin atmosphere provides minimal thermal regulation. The day-facing side is habitable in the equatorial band; the night side is extremely cold. Most settlement is near the terminator line where conditions are most stable.",
    renderColor: "#9B7653",
    accentColor: "rgba(155, 118, 83, 0.35)",
    spaceports: [
      {
        id: "kalos_deep_port",
        name: "Kalos Deep Port",
        type: "surface",
        description:
          "The main arrival and departure hub for the entire Vareth system. Heavy industrial character — freight docks dwarf the passenger terminals. The busiest port in the outer belt.",
      },
    ],
    routes: [
      {
    ...
    imageSlots: {
      ...
      surface:
        "Kalos industrial zone — ore processing machinery and pressurised worker habitats",
      spaceport:
        "Kalos Deep Port — freight docks with automated ore loaders, passenger terminal beyond",
    },
  },
  ...
  thal: {
    ...
    description:
      "A tidally heated moon kept geologically active by Vareth's gravitational flexing. Geothermal vent fields across the surface, harnessed for energy production. A scientific and engineering colony with a growing volcanic tourism trade.",
    ...
    climate:
      "Extreme volcanic activity across most of the surface. Stable zones near the polar regions. Vent emissions create unpredictable atmospheric chemistry events requiring constant monitoring.",
    renderColor: "#B45309",
    accentColor: "rgba(180, 83, 9, 0.35)",
    spaceports: [
      {
        id: "thal_thermal_station",
        name: "Thal Thermal Station",
        type: "surface",
        description:
          "Built on a geologically stable plateau above the vent fields. The approach corridor between two active vent ridges is considered one of the most dramatic landing sequences in the system.",
      },
    ],
    routes: [
      {
    ...
    facts: [
      ...
      {
        label: "Tidal Heating",
        value: "Active — maintained by Vareth resonance",
      },
    ...
    imageSlots: {
      ...
      surface:
        "Thal geothermal station — energy extraction infrastructure with glowing vents in background",
      spaceport:
        "Thal Thermal Station — approach between two active ridges with steam plumes on either side",
    },
  },
  ...
  mira: {
    ...
    climate:
      "No atmosphere. Surface is actively reshaped by tidal flexing from Vareth-Thal resonance. The subsurface ocean maintains relatively stable thermal conditions around hydrothermal vents.",
    renderColor: "#BAE6FD",
    accentColor: "rgba(186, 230, 253, 0.25)",
    spaceports: [
      {
        id: "mira_access_point",
        name: "Mira Access Point",
        type: "orbital",
        description:
          "A strictly controlled orbital station. Permits are checked before docking. No surface landings permitted for civilian vessels. The station maintains the most comprehensive biosafety quarantine protocols in the system.",
      },
    ],
    routes: [
      {
    ...
    imageSlots: {
      ...
      surface:
        "Mira ice surface detail — tidal fracture lines and cryovolcanic deposits",
      spaceport:
        "Mira Access Point orbital station — permit checkpoint with ice moon surface below",
    },
  },
  ...
  calyx: {
    ...
    description:
      "A small, dense ice planet in the outer system beyond the Scatter. Extraordinarily cold and mineral-rich. Colonists live almost entirely underground or in pressurised surface domes, and have developed a culture that is deeply interior-focused.",
    ...
    economy: [
      ...
      "Cryo-Technology Manufacturing",
      "Research",
      "Underground Agriculture",
    ],
    climate:
      "Permanently extreme cold. Virtually no weather events — the thin atmosphere is too cold for significant dynamics. Surface is visually featureless at distance; underground, conditions are carefully managed and stable.",
    renderColor: "#BAE6FD",
    accentColor: "rgba(186, 230, 253, 0.2)",
    spaceports: [
      {
        id: "calyx_port_north",
        name: "Calyx North Port",
        type: "surface",
        description:
          "The primary northern hemisphere surface port. Connects to the largest underground city network.",
      },
      {
        id: "calyx_port_equatorial",
        name: "Calyx Equatorial Port",
        type: "surface",
        description:
          "Mid-latitude surface port with the highest traffic volume on Calyx. Primary commercial hub.",
      },
      {
        id: "calyx_port_deep",
        name: "Calyx Deep Station",
        type: "surface",
        description:
          "A deep-ice port integrated directly into the underground city network. The most sheltered departure point in the system.",
      },
    ],
    routes: [
      {
    ...
    imageSlots: {
      ...
      surface:
        "Calyx underground city — vast illuminated cavern with artificial sky lighting and architectural density",
      spaceport:
        "Calyx Equatorial Port — surface structure emerging from ice plain, stars and distant binary suns visible",
      extra:
        "Calyx interior — the city from within, layered terraces of habitation carved into ancient ice",
    },
  },
  ...
  lun: {
    ...
    description:
      "A dark rocky moon with subsurface liquid water pockets. Colonised primarily for its strategic orbital position — ideal for deep-outer-system observation and relay communications.",
    ...
    climate:
      "No atmosphere. Very low gravity creates unusual surface dynamics. The subsurface pockets of liquid water (maintained by trace internal heating) are not accessible from the inhabited zones.",
    renderColor: "#78716C",
    ...
    spaceports: [
      {
        ...
        type: "surface",
        description:
          "Primary and only port on Lun. Mixed scientific and civilian use. The observation deck above the terminal offers an unobstructed view of Calyx and the outer system.",
      },
    ],
    routes: [
      {
    ...
    imageSlots: {
      ...
      surface:
        "Lun observatory complex — antenna arrays and observation domes against a starfield",
      spaceport:
        "Lun Station — compact terminal with Calyx visible through the viewport wall",
    },
  },
  ...
  vael: {
    ...
    climate:
      "No atmosphere. Highest albedo of any inhabited body in the system — the surface reflects so much light that external sensors require adjustment. Virtually no geological activity.",
    renderColor: "#E2E8F0",
    ...
    spaceports: [
      {
        ...
        type: "surface",
        description:
          "Small, functional mining colony port. The coldest staffed spaceport in the system. Arrivals are greeted with a temperature advisory and a reminder that full EVA gear is required outside pressurised areas at all times.",
      },
    ],
    routes: [
      {
    ...
    imageSlots: {
      ...
      surface:
        "Vael mining operation — surface extraction machinery on ultra-reflective terrain",
      spaceport:
        "Vael Station — functional pressurised terminal, frosted viewports, mining equipment visible outside",
    },
  },
};
