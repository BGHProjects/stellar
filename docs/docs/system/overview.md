...
| Kael                      | Moon of Aethon           | No                     | —                    |
| Seren                     | Moon of Aethon           | No                     | —                    |
| Veth                      | Moon of Aethon           | No                     | —                    |
| _The Scatter_             | Debris field             | —                      | —                    |
| Vareth                    | Gas giant                | No                     | —                    |
| **Kalos**                 | Moon of Vareth           | **Yes**                | **1**                |
| **Thal**                  | Moon of Vareth           | **Yes**                | **1**                |
| **Mira**                  | Moon of Vareth           | **Yes (restricted)**   | **1 (orbital only)** |
| **Calyx**                 | Ice planet               | **Yes**                | **3**                |
| **Lun**                   | Moon of Calyx            | **Yes**                | **1**                |
| **Vael**                  | Moon of Calyx            | **Yes**                | **1**                |
| Drath                     | Gas giant                | No                     | —                    |
...
At the L4 and L5 gravitational equilibrium points of the binary pair sit two permanent deep-space installations. These are points where the competing gravity of both stars perfectly cancels, creating naturally stable positions. They serve as refuelling depots, navigation waypoints, and emergency shelters. The Aethon ↔ L4 and Aethon ↔ L5 shuttle routes run every 3 days on Helion-class vessels.
